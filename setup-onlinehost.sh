...
curl -s https://github.com/dinhduan2710/docker-wordpres.git/master/docker-compose-onlinehost.yml > $compose_file
curl -s https://github.com/dinhduan2710/docker-wordpres.git/master/.env > $env_file
